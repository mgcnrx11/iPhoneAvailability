package im.jianyu.extractor;

import com.alibaba.fastjson.JSON;
import im.jianyu.model.store.CNStore;
import im.jianyu.model.store.Store;
...
public class CNStoreExtractor {
    ...
    static {
        cnStore = JSON.parseObject(storeJson, CNStore.class);
    }

    /**
     * FullStoreName即组合城市与零售店名。如：广州 天环广场
